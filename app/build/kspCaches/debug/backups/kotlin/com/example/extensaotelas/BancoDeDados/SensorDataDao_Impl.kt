...
public class SensorDataDao_Impl(
  ...
  public override suspend fun insert(sensorData: SensorDataEntity): Unit = performSuspending(__db,
      false, true) { _connection ->
    __insertAdapterOfSensorDataEntity.insert(_connection, sensorData)
  }

  public override suspend fun insertAll(sensorDataList: List<SensorDataEntity>): Unit =
      performSuspending(__db, false, true) { _connection ->
    __insertAdapterOfSensorDataEntity.insert(_connection, sensorDataList)
  }

  public override fun getAllSensorDataFlow(): Flow<List<SensorDataEntity>> {
  ...
  public override suspend fun getMaxTimestamp(): Long? {
